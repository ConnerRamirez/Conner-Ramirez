...
.NO_PARALLEL:${OBJECTDIR}/GLADDIS\ CH\ 2\ Q10.o
${OBJECTDIR}/GLADDIS\ CH\ 2\ Q10.o: GLADDIS\ CH\ 2\ Q10.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GLADDIS\ CH\ 2\ Q10.o GLADDIS\ CH\ 2\ Q10.cpp
